...
import { FormConfig } from 'src/app/ui/models/form-config.interface';
...
export class EditPageComponent implements OnInit, OnDestroy {
  private path = '/api/node/';
  public rootId = '00000000-0000-4000-8000-000000000000';
  public currentNodeId: string = this.rootId;
  public currentNodeType = 'UNKOWN';
  public currentNodeTitle = 'NODE';
  public listOfFields = [];
  public listOfNodeIds = [];
  public listOfChildren = [];
  public breadcrumb = [];
  public nodeFormConfig: FormConfig = {
    name: 'nodeForm',
    controls: [
      {
        name: 'sample1',
  ...
  constructor(
    ...
    this.path = `${loc.protocol}//${loc.host}/api/node/`;
